...
//        }
	...
	private static TileCache createTileCache(final int index, final int capacity) {
	...
	private static TileDownloadLayer createTileDownloadLayer(	final TileCache tileCache,
	...
	private static TileRendererLayer createTileRendererLayer(	final TileCache tileCache,
																final MapViewPosition mapViewPosition,
	...
	public static void main(final String[] args) {
		...
		final List<File> mapFiles = getMapFiles(args);
...
//				final int result = JOptionPane.showConfirmDialog(frame, MESSAGE, TITLE, JOptionPane.YES_NO_OPTION);
...
//			}
			...
			public void windowOpened(final WindowEvent e) {
				...
				final byte zoomLevel = LatLongUtils.zoomForBounds(
